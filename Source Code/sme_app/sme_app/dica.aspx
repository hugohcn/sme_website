<%@ Page Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="dica.aspx.cs" Inherits="sme_app.dica" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="rContent">
        <label id="Label1" class="titulo_bloco" runat="server">Dicas</label>
        <br />
        ...
        <br />
        <label runat="server" id="fonteDica" style="font-family: Verdana; font-size: 11px; color: #31547A;"></label>
    </div>
