<%@ Page Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true"
    CodeBehind="ManterPaginaEstruturaOrganizacionalForm.aspx.cs" Inherits="AreaAdministrativa.ManterPaginaEstruturaOrganizacionalForm"
    Title="Oficina SME | Área Administrativa - Manter Página 'Estrutura Organizacional'" %>
...
<dx:ASPxHiddenField ID="hdnTituloImagem" ClientInstanceName="hdnTituloImagem" runat="server">
	...
	popNovoAlbum.Show();
                                ...
                                <ItemTemplate>
                                    <div style="text-align: center;">
                                        ...
                                        <div style="margin: 5px 0 5px 0; line-height: 19px;">
                                            <a href="javascript:void(0);" style="text-decoration: none; font-family: Verdana;
                                            ...
                                            <br />
                                            <a style="cursor: pointer; color: #666666;" onclick="<%# "cbSalvarDadosPagina.PerformCallback('" + Eval("id_album_foto").ToString() + "?D');" %>">
                                                Remover Foto</a>
                                        </div>
                                    </div>
                                </ItemTemplate>
                            ...
                            <asp:ObjectDataSource ID="odsAlbumFotoEmpresa" runat="server" SelectMethod="RecuperarFotosPagina"
                                ...
                                <SelectParameters>
                                    <asp:Parameter DefaultValue="pag_estrutura_organizacional" Name="pagina" Type="String" />
                                </SelectParameters>
