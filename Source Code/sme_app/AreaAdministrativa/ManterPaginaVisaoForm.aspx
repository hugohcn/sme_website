<%@ Page Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true"
    CodeBehind="ManterPaginaVisaoForm.aspx.cs" Inherits="AreaAdministrativa.ManterPaginaVisaoForm"
    Title="Oficina SME | Área Administrativa - Manter Página 'Visão'" %>
...
<%@ Register assembly="DevExpress.Web.v9.3, Version=9.3.2.0, Culture=neutral, PublicKeyToken=8d332da86fe888ab" namespace="DevExpress.Web.ASPxHiddenField" tagprefix="dx1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	lpCarregando.Hide();
            ...
            <dx:ASPxPopupControl ID="popNovoAlbum" runat="server" AllowDragging="True" ClientInstanceName="popNovoAlbum"
                ...
                FooterText="" HeaderText="Inserir/Editar Álbum de Fotos" Modal="True" PopupHorizontalAlign="WindowCenter"
                PopupVerticalAlign="WindowCenter" SpriteCssFilePath="~/App_Themes/Aqua/{0}/sprite.css"
                Width="600px" ShowCloseButton="False">
                                ...
                                <td>
                                    <div style="width: 250px; margin: 0 auto;">
                                        <div style="float: left; margin-right: 10px;">
                                            <dx:ASPxButton ID="btnEnviar" runat="server" Text="Enviar" Width="120px" AutoPostBack="False"
		...
		alert(&quot;Os campos 'Título do Álbum' e 'Descrição' são obrigatórios!&quot;);
                                        ...
                                        <div style="float: left;">
                                            <dx:ASPxButton ID="btnCancelar" runat="server" Text="Cancelar" Width="120px" AutoPostBack="False"
                                                CssFilePath="~/App_Themes/Aqua/{0}/styles.css" CssPostfix="Aqua" CausesValidation="False">
                                                <ClientSideEvents Click="function(s, e) {
	              ResetarCamposNovoAlbum();
	popNovoAlbum.Hide();
}" />
